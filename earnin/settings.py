"""
Django settings for earnin project.
...
SECRET_KEY = "django-insecure-v)d$w2w4^r#_h1$x7zd)5y^if!q#l^%qx6^_k&842-hdw#2pc2"
...
DATABASES = {
    ...
    "default": dj_database_url.config(
        default=config(
            "DATABASE_URL",
            default="postgres://postgres:postgres@localhost:5432/core",
            cast=str,
        ),
        conn_max_age=600,
    )
